...
ASUNTO_PATTERNS: dict[str, list[AsuntoPattern]] = {
    ...
    "Gestión de Cargos Docentes": [
        AsuntoPattern(
            asunto="Solicitud de cargo Jefe de Trabajos Prácticos",
            pattern=r"JEFE\s+TRAB(?:AJOS)?\.?\s+PR[AÁ]CTICOS?",
        ),
        AsuntoPattern(asunto="Solicitud de cargo Ayudante de 1ra", pattern=r"AYUDANTE\s+DE\s+1RA"),
        AsuntoPattern(
            asunto="Solicitud de cargo Ayudante de Cátedra", pattern=r"AYUDANTE\s+DE\s+C[AÁ]TEDRA"
        ),
        AsuntoPattern(asunto="Solicitud de cargo Profesor Adjunto", pattern=r"PROFESOR\s+ADJUNTO"),
        AsuntoPattern(
            asunto="Solicitud de cargo Profesor Asociado", pattern=r"PROFESOR\s+ASOCIADO"
        ),
        AsuntoPattern(asunto="Solicitud de cargo Profesor Titular", pattern=r"PROFESOR\s+TITULAR"),
        AsuntoPattern(
            asunto="Solicitud de cargo Horas de Cátedra", pattern=r"HORAS?\s+DE\s+C[AÁ]TEDRA"
        ),
        ...
        AsuntoPattern(
            asunto="Solicitud de cargo FBCB", pattern=r"SOLICITUD\s+DE\s+CARGO\s+DE\s+FBCB"
        ),
    ],
    # ===========================================================
    ...
    "Gestion de Pago a Proveedores": [
        AsuntoPattern(
            asunto="Liquidación y pago a proveedores",
            pattern=r"LIQUIDACI[OÓ]N\s+Y\s+PAGO\s+A\s+PROVEEDORES?",
        ),
    ...
    "Gestión de Fondos con cargo a rendición": [
        AsuntoPattern(
            asunto="Solicitud de adelanto a responsable", pattern=r"ADELANTO\s+A\s+RESPONSABLE"
        ),
    ...
    "Gestión de Bienes Patrimoniales": [
        ...
        AsuntoPattern(
            ...
            pattern=r"BAJA\s+(?:DE\s+)?BIENES?|BAJA\s+PATRIMONIAL|BAJA\s+DE\s+ELEMENTOS",
        ),
        AsuntoPattern(
            asunto="Incorporación al patrimonio",
            pattern=r"INCORPORACI[OÓ]N\s+(?:AL\s+)?PATRIMONIO|INCORPORAR\s+AL\s+PATRIMONIO",
        ),
        AsuntoPattern(asunto="Transferencia de bienes", pattern=r"TRANSFERENCIA\s+DE\s+BIENES?"),
        AsuntoPattern(
            asunto="Inventario de bienes", pattern=r"INVENTARIO\s+DE\s+BIENES?|INVENTARIADO"
        ),
        AsuntoPattern(asunto="Donación", pattern=r"DONACI[OÓ]N|DONAR"),
        AsuntoPattern(
            asunto="Pedido de bienes", pattern=r"PEDIDO\s+DE\s+BIENES|SOLICITUD\s+DE\s+BIENES"
        ),
        ...
        AsuntoPattern(
            asunto="Ampliación de espacio", pattern=r"AMPLIAR\s+(?:UNA\s+)?OFICINA|AMPLIACI[OÓ]N"
        ),
        AsuntoPattern(
            asunto="Baja de elementos inventariados",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+INVENTARIADOS",
        ),
        AsuntoPattern(asunto="Incorporación de libros", pattern=r"INCORPORACI[OÓ]N\s+DE\s+LIBROS"),
        AsuntoPattern(
            asunto="Incorporación de elementos", pattern=r"INCORPORACI[OÓ]N\s+DE\s+ELEMENTOS"
        ),
        AsuntoPattern(asunto="Baja por deterioro", pattern=r"BAJA\s+POR\s+DETERIORO|DETERIORO"),
        AsuntoPattern(
            asunto="Baja por obsolescencia", pattern=r"BAJA\s+POR\s+OBSOLESCENCIA|OBSOLESCENCIA"
        ),
        AsuntoPattern(
            asunto="Baja por antigüedad", pattern=r"BAJA\s+POR\s+ANTIG[ÜU]EDAD|ANTIG[ÜU]EDAD"
        ),
        ...
        AsuntoPattern(
            asunto="Baja por deterioro de elementos",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+DETERIORO",
        ),
        AsuntoPattern(
            asunto="Baja por obsolescencia de elementos",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+OBSOLESCENCIA",
        ),
        AsuntoPattern(
            asunto="Baja por antigüedad de elementos",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+ANTIG[ÜU]EDAD",
        ),
        AsuntoPattern(
            asunto="Baja por siniestro de elementos",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+SINIESTRO",
        ),
        AsuntoPattern(
            asunto="Baja por daño de elementos", pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+DA[ÑN]O"
        ),
        AsuntoPattern(
            asunto="Baja por pérdida de elementos",
            pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+[PÉP]RDIDA",
        ),
        AsuntoPattern(
            asunto="Baja por robo de elementos", pattern=r"BAJA\s+DE\s+ELEMENTOS\s+POR\s+ROBO"
        ),
    ],
    # ===========================================================
    ...
    "Gestión de Becas": [
        ...
        AsuntoPattern(
            asunto="Prórroga de beca", pattern=r"PR[OÓ]RROGA\s+DE\s+BECA|PR[OÓ]RROGA.*BCSI"
        ),
        ...
        AsuntoPattern(
            asunto="Beca de comisión de servicios",
            pattern=r"BECA\s+DE\s+COMISI[OÓ]N\s+DE\s+SERVICIOS",
        ),
        AsuntoPattern(
            asunto="Beca de integración académica",
            pattern=r"BECA\s+DE\s+INTEGRACI[OÓ]N\s+ACAD[EÉ]MICA",
        ),
        AsuntoPattern(asunto="Cientibeca", pattern=r"SCIENTIBECA|CIENTIBECA"),
        AsuntoPattern(
            asunto="Levantamiento de incompatibilidad",
            pattern=r"LEVANTAMIENTO\s+DE\s+INCOMPATIBILIDAD|LEVANTAMIENTO\s+INCOMPATIBILIDAD",
        ),
        AsuntoPattern(
            asunto="Orden de prioridad institucional",
            pattern=r"ORDEN\s+DE\s+PRIORIDAD\s+INSTITUCIONAL",
        ),
        ...
        AsuntoPattern(
            asunto="Inscripción a tesina", pattern=r"INSCRIPCI[OÓ]N\s+(?:A\s+)?(?:LA\s+)?TESINA"
        ),
        AsuntoPattern(
            asunto="Inscripción a materia", pattern=r"INSCRIPCI[OÓ]N\s+(?:A\s+)?(?:LA\s+)?MATERIA"
        ),
        ...
        AsuntoPattern(
            asunto="Incorporación como codirector", pattern=r"INCORPORACI[OÓ]N.*CODIRECTOR"
        ),
        AsuntoPattern(
            asunto="Solicitud de beca de inicio", pattern=r"BIA|BECA\s+DE\s+INICIACI[OÓ]N"
        ),
        AsuntoPattern(
            asunto="Renuncia de beca EVC-CIN", pattern=r"RENUNCIA.*EVC-CIN|RENUNCIA.*BECAS?\s+EVC"
        ),
        AsuntoPattern(
            asunto="Prórroga de beca por comisión", pattern=r"PR[OÓ]RROGA.*BECA\s+POR\s+COMISI[OÓ]N"
        ),
        AsuntoPattern(
            asunto="Solicitud de inscripción a tesina", pattern=r"SOLICITUD.*INSCRIPCI[OÓ]N.*TESINA"
        ),
        AsuntoPattern(
            asunto="Solicitud de beca por comisión", pattern=r"SOLICITUD.*BECA\s+POR\s+COMISI[OÓ]N"
        ),
    ],
    # ===========================================================
    ...
    "Gestión de Particulares": [
        AsuntoPattern(
            asunto="Certificación de servicios", pattern=r"CERTIFICACI[OÓ]N\s+DE\s+SERVICIOS"
        ),
        AsuntoPattern(
            asunto="Certificación de servicios y remuneraciones",
            pattern=r"CERTIFICACI[OÓ]N\s+DE\s+SERVICIOS\s+Y\s+REMUNERACIONES",
        ),
        ...
        AsuntoPattern(
            asunto="Actualización de haberes",
            pattern=r"ACTUALIZACI[OÓ]N\s+DE\s+HABERES|ACTUALIZACI[OÓ]N\s+DE\s+REMUNERACIONES|ACTUALI[ZC]EN\s+(?:LOS\s+)?HABERES|ACTUALIZACI[OÓ]N\s+HABERES",
        ),
        AsuntoPattern(
            asunto="Certificación de haberes",
            pattern=r"CERTIFICACI[OÓ]N\s+DE\s+HABERES|CERTIFICACI[OÓ]N\s+DE\s+REMUNERACIONES",
        ),
        AsuntoPattern(asunto="Desarchivo", pattern=r"DESARCHIVO"),
        ...
        AsuntoPattern(
            asunto="Certificación complementaria", pattern=r"CERTIFICACI[OÓ]N\s+COMPLEMENTARIA"
        ),
        AsuntoPattern(
            asunto="Rectificación de remuneración",
            pattern=r"RECTIFICACI[OÓ]N.*REMUNERACI[OÓ]N|RECTIFICACI[OÓ]N.*HABERES",
        ),
        AsuntoPattern(
            asunto="Inscripción al concurso", pattern=r"INSCRIPCI[OÓ]N\s+(?:AL\s+)?CONCURSO"
        ),
        ...
        AsuntoPattern(
            asunto="Rescisión de convenio",
            pattern=r"RESCISI[OÓ]N\s+DE\s+CONVENIO|RESCINDIR.*CONVENIO",
        ),
        AsuntoPattern(asunto="Renuncia condicionada", pattern=r"RENUNCIA\s+CONDICIONADA"),
        AsuntoPattern(
            asunto="Uso de opción previsional", pattern=r"OPCI[OÓ]N.*ART.*19|OPCI[OÓ]N.*LEY\s+24241"
        ),
        AsuntoPattern(
            asunto="Solicitud de representante", pattern=r"SOLICITUD\s+DE\s+REPRESENTANTE"
        ),
        AsuntoPattern(
            asunto="Solicitud de certificación actualizada",
            pattern=r"SOLICITUD\s+DE\s+CERTIFICACI[OÓ]N\s+ACTUALIZADA|SOLICITUD.*CERTIFICACI[OÓ]N.*ACTUALIZADA",
        ),
        AsuntoPattern(asunto="Certificación para ANSES", pattern=r"CERTIFICACI[OÓ]N.*ANSES"),
        AsuntoPattern(
            asunto="Actualización de haberes jubilatorios",
            pattern=r"ACTUALIZACI[OÓ]N.*HABERES.*JUBILATORIOS|ACTUALIZAR.*HABERES.*JUBILATORIOS",
        ),
        AsuntoPattern(
            asunto="Solicitud de certificación", pattern=r"SOLICITUD\s+DE\s+CERTIFICACI[OÓ]N"
        ),
        AsuntoPattern(
            asunto="Confirmación de persona", pattern=r"CONFIRME.*PERSONA|CONFIRMAR.*PERSONA"
        ),
    ],
    # ===========================================================
    ...
    "Actas de exámenes y de regularización": [
        ...
        AsuntoPattern(
            asunto="Rectificación de acta", pattern=r"RECTIFICACI[OÓ]N\s+DE\s+ACTA|RECTIFICATIVA"
        ),
        AsuntoPattern(
            asunto="Acta de alumnos externos", pattern=r"ACTA\s+DE\s+ALUMNOS?\s+EXTERNOS?"
        ),
        ...
        AsuntoPattern(
            asunto="Envío de acta",
            pattern=r"ENVI[OÓ]\s+DE\s+ACTA|REMITA?\s+ACTA|REMITE\s+ACTA|ENVIAR\s+ACTA",
        ),
        ...
        AsuntoPattern(
            asunto="Remite acta a facultad",
            pattern=r"REMITE\s+ACTA|REMITE\s+A\s+FACULTAD|REMITIDAS?\s+A\s+FA",
        ),
    ],
    # ===========================================================
    ...
    "Gestión de Órganos de Gobierno y Autoridades": [
        AsuntoPattern(
            asunto="Designación de autoridades",
            pattern=r"DESIGNACI[OÓ]N\s+DE\s+AUTORIDADES?|PROCLAMACI[OÓ]N",
        ),
        AsuntoPattern(asunto="Prórroga de beca", pattern=r"PR[OÓ]RROGA\s+DE\s+BECA"),
        AsuntoPattern(
            asunto="Resolución de CD", pattern=r"RESOLUCI[OÓ]N\s+(?:DEL\s+)?CD|RES\.?\s+CD"
        ),
        ...
        AsuntoPattern(
            asunto="No renovación de contrato",
            pattern=r"NO\s+RENOVACI[OÓ]N\s+(?:DEL?\s+)?CONTRATO|NO\s+RENOVAR",
        ),
        AsuntoPattern(asunto="Taller", pattern=r"TALLER"),
        AsuntoPattern(
            asunto="Prórroga de beca por comisión de servicios",
            pattern=r"PR[OÓ]RROGA.*BCSI|BCSI|PR[OÓ]RROGA.*BECA\s+POR\s+COMISI[OÓ]N",
        ),
        ...
        AsuntoPattern(
            asunto="Designación de representante", pattern=r"DESIGNACI[OÓ]N\s+DE\s+REPRESENTANTE"
        ),
        AsuntoPattern(
            asunto="Designación de coordinador", pattern=r"DESIGNACI[OÓ]N\s+DE\s+COORDINADOR"
        ),
        AsuntoPattern(
            asunto="Cursado de asignatura",
            pattern=r"CURSADO\s+DE\s+ASIGNATURA|CURSADO\s+DE\s+MATERIA",
        ),
        ...
        AsuntoPattern(
            asunto="Propuesta de designación",
            pattern=r"PROPUESTA\s+DE\s+DESIGNACI[OÓ]N|PROPUESTA.*DESIGNAR",
        ),
        AsuntoPattern(
            asunto="Eleva propuesta", pattern=r"ELEVA\s+PROPUESTA|ELEVACI[OÓ]N\s+DE\s+PROPUESTA"
        ),
        AsuntoPattern(
            asunto="Informa integración", pattern=r"INFORMA.*INTEGRACI[OÓ]N|INFORMA.*COMISI[OÓ]N"
        ),
        ...
        AsuntoPattern(
            asunto="Cubrimiento de vacante", pattern=r"CUBRIMIENTO\s+DE\s+VACANTE|CUBRIR\s+VACANTE"
        ),
        AsuntoPattern(
            asunto="Prórroga de Beca de Integración Académica",
            pattern=r"PR[OÓ]RROGA.*BECA\s+DE\s+INTEGRACI[OÓ]N",
        ),
        AsuntoPattern(
            asunto="Designación de profesor", pattern=r"DESIGNACI[OÓ]N.*PROFESOR|DESIGNAR.*PROFESOR"
        ),
        ...
        AsuntoPattern(
            asunto="Cubrimiento de cargo", pattern=r"CUBRIMIENTO\s+DE\s+CARGO|CUBRIR.*CARGO"
        ),
        AsuntoPattern(
            asunto="Sistema de formación extracurricular",
            pattern=r"SISTEMA\s+DE\s+FORMACI[OÓ]N\s+EXTRACURRICULAR",
        ),
        AsuntoPattern(asunto="Propuesta de pautas", pattern=r"PROPUESTA\s+DE\s+PAUTAS"),
        AsuntoPattern(
            asunto="Cubrimiento de cargo", pattern=r"CUBRIMIENTO\s+DE\s+CARGO|CUBRIR.*CARGO"
        ...
        AsuntoPattern(
            asunto="Informa integración de comisiones",
            pattern=r"INFORMA.*INTEGRACI[OÓ]N.*COMISI[OÓ]N",
        ),
        AsuntoPattern(
            asunto="Propuesta de designación de profesor",
            pattern=r"PROPUESTA.*DESIGNACI[OÓ]N.*PROFESOR",
        ),
        AsuntoPattern(
            asunto="Designación de jefe de emergencia", pattern=r"JEFE\s+DE\s+EMERGENCIA"
        ),
        AsuntoPattern(
            asunto="Propuesta de pautas para designación",
            pattern=r"PROPUESTA.*PAUTAS.*DESIGNACI[OÓ]N",
        ),
        AsuntoPattern(
            asunto="Vacante en formación extracurricular",
            pattern=r"VACANTE.*FORMACI[OÓ]N\s+EXTRACURRICULAR",
        ),
        AsuntoPattern(
            asunto="Solicitud de autorización para cubrimiento",
            pattern=r"SOLICITUD.*AUTORIZACI[OÓ]N.*CUBRIMIENTO",
        ),
    ],
    # ===========================================================
    # SAT - SET
    ...
    "Migración": [
        ...
        AsuntoPattern(
            asunto="Certificado de finalización", pattern=r"CERTIFICADO\s+DE\s+FINALIZACI[OÓ]N"
        ),
        ...
        AsuntoPattern(
            asunto="Cubrimiento de cargo", pattern=r"CUBRIMIENTO\s+DE\s+CARGO|CUBRIR\s+UN\s+CARGO"
        ),
    ...
    "Normativa Institucional y externa": [
        ...
        AsuntoPattern(asunto="Protocolo", pattern=r"PROTOCOLO"),
        AsuntoPattern(
            asunto="Convocatoria a sesión",
            pattern=r"CONVOCANDO\s+AL\s+CONSEJO|CONVOCATORIA.*SESI[OÓ]N|REUNI[OÓ]N\s+ORDINARIA",
        ),
        AsuntoPattern(
            asunto="Propuesta curricular", pattern=r"PROPUESTA\s+CURRICULAR|MODIFICACIONES"
        ),
    ...
    "Elecciones": [
        AsuntoPattern(
            asunto="Designación de autoridades", pattern=r"DESIGNACI[OÓ]N\s+DE\s+AUTORIDADES"
        ),
        ...
        AsuntoPattern(
            asunto="Elección de autoridades", pattern=r"ELECCI[OÓ]N\s+DE\s+AUTORIDADES|ELECCI[OÓ]N"
        ),
        AsuntoPattern(asunto="Designación de jurado", pattern=r"DESIGNACI[OÓ]N\s+DE\s+JURADO"),
    ...
    "Accidentes y siniestros": [
        ...
        AsuntoPattern(
            asunto="Simulacro de evacuación", pattern=r"SIMULACRO\s+DE\s+EVACUACI[OÓ]N|SIMULACRO"
        ),
    ...
    "Presupuesto": [
        ...
        AsuntoPattern(
            asunto="Aprobación de presupuesto", pattern=r"APROBACI[OÓ]N\s+DE\s+PRESUPUESTO"
        ),
    ],
    # Denuncia y Sumario
    "Denuncia y Sumario": [
    ...
    "Pasantias y Adscripciones": [
        ...
        AsuntoPattern(
            asunto="Formación extracurricular", pattern=r"FORMACI[OÓ]N\s+EXTRACURRICULAR"
        ),
...
def extract_asunto(descripcion: str, concepto: str) -> str | None:
    """
